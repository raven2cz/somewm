...
-- Colors — Monokai Pro palette
local bg_base       = "#2d2a2e"  -- Background
local bg_surface    = "#403e41"  -- Surface
local bg_overlay    = "#5b595c"
local fg_main       = "#fcfcfa"  -- Foreground
local fg_dim        = "#939293"  -- Comment
local fg_muted      = "#5b595c"
local accent        = "#ffd866"  -- Yellow
local accent_dim    = "#e6c25a"
local urgent        = "#ff6188"  -- Red
local green         = "#a9dc76"  -- Green
local marked        = "#fc9867"  -- Orange
...
-- Widget component colors (Monokai Pro palette)
theme.theme_name              = "monokai-pro"
theme.widget_spacing          = dpi(6)
theme.widget_font             = "Geist 10"
theme.widget_cpu_color        = "#78dce8"  -- Blue/Cyan
theme.widget_gpu_color        = green      -- #a9dc76 Green
theme.widget_memory_color     = "#ff6188"  -- Red/Pink
