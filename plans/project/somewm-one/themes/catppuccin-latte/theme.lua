...
-- Colors — Catppuccin Latte palette (light)
local bg_base       = "#eff1f5"  -- Base
local bg_surface    = "#ccd0da"  -- Surface0
local bg_overlay    = "#bcc0cc"  -- Surface1
local fg_main       = "#4c4f69"  -- Text
local fg_dim        = "#6c6f85"  -- Subtext0
local fg_muted      = "#9ca0b0"  -- Overlay0
local accent        = "#8839ef"  -- Mauve
local accent_dim    = "#7287fd"  -- Lavender
local urgent        = "#d20f39"  -- Red
local green         = "#40a02b"  -- Green
local marked        = "#fe640b"  -- Peach
...
-- Borders — mauve accent
theme.useless_gap         = dpi(3)
theme.border_width        = dpi(1)
theme.border_color_normal = bg_surface
...
theme.shadow_drawin_opacity   = 0.25
...
-- Widget component colors (Catppuccin Latte palette)
theme.theme_name              = "catppuccin-latte"
theme.widget_spacing          = dpi(6)
theme.widget_font             = "Geist 10"
theme.widget_cpu_color        = "#1e66f5"  -- Blue
theme.widget_gpu_color        = green      -- #40a02b Green
theme.widget_memory_color     = "#ea76cb"  -- Pink
theme.widget_disk_color       = "#df8e1d"  -- Yellow
theme.widget_network_color    = "#179299"  -- Teal
theme.widget_volume_color     = "#d20f39"  -- Red
theme.widget_updates_color    = "#fe640b"  -- Peach
theme.widget_keyboard_color   = "#04a5e5"  -- Sky
theme.widget_clock_color      = accent     -- #8839ef Mauve
