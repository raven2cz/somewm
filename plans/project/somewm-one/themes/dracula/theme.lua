...
local bg_base       = "#282a36"  -- Background
local bg_surface    = "#44475a"  -- Current Line
local bg_overlay    = "#4d5066"
local fg_main       = "#f8f8f2"  -- Foreground
local fg_dim        = "#6272a4"  -- Comment
local fg_muted      = "#44475a"
local accent        = "#bd93f9"  -- Purple
local accent_dim    = "#9580d1"
local urgent        = "#ff5555"  -- Red
local green         = "#50fa7b"  -- Green
local marked        = "#ffb86c"  -- Orange
...
-- Widget component colors (Dracula palette)
theme.theme_name              = "dracula"
theme.widget_spacing          = dpi(6)
theme.widget_font             = "Geist 10"
theme.widget_cpu_color        = "#8be9fd"  -- Cyan
theme.widget_gpu_color        = green      -- #50fa7b Green
theme.widget_memory_color     = "#ff79c6"  -- Pink
theme.widget_disk_color       = "#f1fa8c"  -- Yellow
theme.widget_network_color    = accent     -- #bd93f9 Purple
theme.widget_volume_color     = "#ff5555"  -- Red
theme.widget_updates_color    = "#ffb86c"  -- Orange
theme.widget_keyboard_color   = "#8be9fd"  -- Cyan
theme.widget_clock_color      = accent     -- #bd93f9 Purple
