...
local bg_base       = "#1e1e2e"  -- Base
local bg_surface    = "#313244"  -- Surface0
local bg_overlay    = "#45475a"  -- Surface1
local fg_main       = "#cdd6f4"  -- Text
local fg_dim        = "#a6adc8"  -- Subtext0
local fg_muted      = "#585b70"  -- Surface2
local accent        = "#cba6f7"  -- Mauve
local accent_dim    = "#b4befe"  -- Lavender
local urgent        = "#f38ba8"  -- Red
local green         = "#a6e3a1"  -- Green
local marked        = "#fab387"  -- Peach
...
-- Widget component colors (Catppuccin Mocha palette)
theme.theme_name              = "catppuccin"
theme.widget_spacing          = dpi(6)
theme.widget_font             = "Geist 10"
theme.widget_cpu_color        = "#89b4fa"  -- Blue
theme.widget_gpu_color        = green      -- #a6e3a1 Green
theme.widget_memory_color     = "#f5c2e7"  -- Pink
