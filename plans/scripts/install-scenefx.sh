...
#
# Usage:
#   ./plans/scripts/install-scenefx.sh          # build + install
#   ./plans/scripts/install-scenefx.sh --check  # just verify current install
#
...
echo "  2. Run: ~/git/github/somewm/plans/scripts/start.sh"
