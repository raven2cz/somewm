...
-- undoing the LyrOverlay placement from mapnotify(). This placed popups
-- below floating parent windows.
--
-- Fix: client_layer_translator() now returns WINDOW_LAYER_ONTOP for
-- override_redirect clients (maps to LyrOverlay), matching X11 semantics
-- where override_redirect windows always display above managed windows.
--
-- This test:
